...
export default function MessagingScreen(){
 ...
 const scrollRef=useRef<ScrollView>(null); const messagesRef=useRef<Message[]>([]); const openRequestRef=useRef(0); const mountedRef=useRef(true);
 useEffect(()=>{
 ...
 useEffect(() => {
  ...
  void markConversationRead(conversationId, messages);
...
return path;}
 ...
 function backFromChat(){++openRequestRef.current;setSelectedContact(null);setConversationId(null);setMessages([]);setMediaUrls({});setError("");}
