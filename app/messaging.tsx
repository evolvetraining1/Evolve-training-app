...
const styles=StyleSheet.create({
 ...
 back:{color:colors.yellow,fontWeight:"900",marginBottom:18},sectionTitle:{color:colors.text,fontSize:20,fontWeight:"900",letterSpacing:1.4,marginBottom:14},contactCard:{minHeight:84,flexDirection:"row",alignItems:"center",borderWidth:1,borderColor:colors.border,backgroundColor:colors.surface,borderRadius:20,padding:14,marginBottom:12},
 contactCardUnread:{borderColor:colors.yellow,backgroundColor:"#151300"},
 avatar:{width:52,height:52,borderRadius:16,borderWidth:1,borderColor:colors.yellow,backgroundColor:colors.surface2,alignItems:"center",justifyContent:"center",marginRight:14},avatarText:{color:colors.yellow,fontSize:22,fontWeight:"900"},contactIdentity:{flex:1},contactName:{color:colors.text,fontSize:18,fontWeight:"900"},contactRole:{color:colors.muted,marginTop:4},
